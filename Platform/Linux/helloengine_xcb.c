...
// note this file should be compiled with the following command in clang:
// clang -I /opt/local/include/ -L /opt/local/lib -lxcb -o helloengine_xcb helloengine_xcb.c
//
    ...
    while ((pEvent = xcb_wait_for_event(pConn)) && !isQuit) {
        switch (pEvent->response_type & ~0x80) {
            case XCB_EXPOSE: {
                ...
                xcb_poly_fill_rectangle(pConn,      /* connection */
                                        window,     /* window or pix-map to draw on */
